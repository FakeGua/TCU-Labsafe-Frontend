<template>
    <div>
        ...
        <div class="row">
            <div class="col-6">
                <div class="row">
                    <div class="file" v-for="(item, index) in oddFiles" :key="index" @click="downloadFile(item.file_name,item.file_category)">
                        <img src="../assets/exam/ppt.svg" alt="">
                        <div class="title h4" v-text="item.file_name"></div>
            ...
            <div class="col-6">
                <div class="row">
                    <div class="file" v-for="(item, index) in evenFiles" :key="index" @click="downloadFile(item.file_name,item.file_category)">
                        <img src="../assets/exam/ppt.svg" alt="">
                        <div class="title h4" v-text="item.file_name"></div>
                        <div class="info text-muted">
                            文件上传日期：{{item.addtime}}
...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.get(`${domain}/exam/getfiles`).then((data) => {
